...
<div class="container">
    <div class="product-detail">
        <img src="upload/product/1.jpg" alt="intel core i9assets/upload/product/1.jpg">
        <div class="product-info">
            <div class="product-title">Intel Core i9 </div>
    ...
    <div class="specifications">
        ...
        <ul>
            <li>Dòng CPU	Core i9</li>
            <li>CPU	Intel® Core® i9-14900K (Raptor Lake)</li>
            <li>Bộ nhớ đệm 36MB Intel® Smart Cache</li>
            <li>Bộ nhớ hỗ trợ tối đa 192GB</li>
            <li>Nhân đồ họa tích hợp Intel® UHD Graphics 770</li>
