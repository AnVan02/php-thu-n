...
@media (max-width: 768px) {
	...
	<!-- tin tức-->
	<header>
        <h2>Google cân nhắc xây trung tâm dữ liệu khổng lồ tại Việt Nam</h2>
    </header>

    <main>

<p>Nguồn tin của Reuters khẳng định Google đang cân nhắc xây dựng một trung tâm dữ liệu (DC) cỡ lớn tại Việt Nam, có mức độ tiêu thụ điện năng tương đương với một thành phố, mức đầu tư có thể lên đến 300-650 triệu USD.</p>

<p>Thông tin cho biết, vị trí đặt trung tâm dữ liệu siêu lớn này có thể ở gần TP.HCM nhưng khoản đầu tư cụ thể chưa được tiết lộ. Nguồn tin của Reuters cho hay, chưa rõ thời điểm Google sẽ đạt thỏa thuận đầu tư nhưng những cuộc thảo luận nội bộ đã được đưa ra và trung tâm dữ liệu này có thể đi vào vận hành năm 2027.

<p>Trung tâm dữ liệu Google muốn xây sẽ là loại có kích thước lớn nhất, mức tiêu thụ điện năng có thể lên tới 50 MW, tương đương với một thành phố lớn và tốn khoản đầu tư 300-650 triệu USD.</p>
<img src="../assets/upload/news/11.jpg" alt="Thẻ Nhớ CFexpress 4.0">
<p>Lý do khiến Google có thể lựa chọn xây trung tâm dữ liệu tại Việt Nam đến từ việc hãng kiếm được ngày càng nhiều khách hàng nội địa và nước ngoài hơn cho các dịch vụ đám mây cũng như sự phát triển mạnh mẽ của nền kinh tế số Việt Nam.</p>

Nguồn tin của Reuters cho biết, Việt Nam chính là thị trường phát triển nhanh nhất của YouTube, dịch vụ chia sẻ video nổi tiếng từ Google.</p>


<p>Hiện tại, những nhà điều hành trung tâm dữ liệu lớn nhất Việt Nam là hãng đầu tư công nghiệp IDC Becamex và nhà mạng VNPT.

Hiện trung tâm dữ liệu lớn nhất Việt Nam là của Viettel, với công suất điện 30 MW, đặt tại Hòa Lạc (Hà Nội).

Hồi tháng 5, nguồn tin từ Nikkei cho hay Alibaba cũng cân nhắc xây trung tâm dữ liệu tại Việt Nam.</p>
