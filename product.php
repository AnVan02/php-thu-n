...
<div class="section-heading">	
				<!-- <div class="box-left">	
					<div class="box-header">
						<h2 class="main"><a href="product.php">Sản phẩm Intel</a></h2>
                        <ul class="cate-list">
							<li><a href="sanpham/intel1.php" title="ASUS">Intel i7</a></li>
							<li><a href="sanpham/intel2.php" title="ACER">Intel i7</a></li>
							<li><a href="sanpham/intel3.php" title="MSI">Intel i9</a></li>
							<li><a href="sanpham/intel4.php" title="LENOVO">Intel i9</a></li>
						</ul>
					</div>
				</div> -->
			</div>
   ...
   <div class="product-container">
    <!-- Product 1 -->
    <a href="sanpham/intel1.php" class="product-link">
    <div class="product-card">
        <img src="assets/upload/products/1.jpg" alt="Intel">
        <h5 class="flash-product__name">Bộ vi xử lý Intel Core i7 14700KF / Turbo up to 5.6GHz / 20 Nhân 28 Luồng / 33MB / LGA 1700</h5>
        <span class="flash-product__price">Liên hệ</span>
        <div class="stars">★★★★★</div>
        <!-- <div class="reviews">12 đánh giá</div> -->
    </div>
    </a>
    <!-- Product 2 -->
    <a href="sanpham/intel2.php" class="product-link">
    <div class="product-card">
        <img src="assets/upload/products/1.jpg" alt="intel">
	   <h5 class="flash-product__name">Bộ vi xử lý Intel Core i7 14700KF / Turbo up to 5.6GHz / 20 Nhân 28 Luồng / 33MB / LGA 1700</h5>
	   <span class="flash-product__price">Liên hệ </span>
        <div class="stars">★★★★★</div>
        <!-- <div class="reviews">1 đánh giá</div> -->
    </div>
    </a>
    <!-- Product 3 -->
    <a href="sanpham/intel3.php" class="product-link">
    <div class="product-card">
    <img src="assets/upload/products/3.jpg" alt="intel ">
    <h5 class="flash-product__name">Bộ vi xử lý Intel Core i9 14900 / Turbo up to 5.8GHz / 24 Nhân 32 Luồng / 36MB / LGA 1700</h5>
	   <span class="flash-product__price">Liên hệ </span>
        <div class="stars">★★★★★</div>
        <!-- <div class="reviews">2 đánh giá</div> -->
    </div>
    </a>
    <!-- Product 4 -->
    <a href="sanpham/intel4.php" class="product-link">
    <div class="product-card">
        <img src="assets/upload/products/4.jpg" alt="intel">
	   <h5 class="flash-product__name">Bộ vi xử lý Intel Core i9 14900 / Turbo up to 5.8GHz / 24 Nhân 32 Luồng / 36MB / LGA 1700</h5>
	   <span class="flash-product__price">Liên hệ </span>
        <div class="stars">★★★★★</div>
        <!-- <div class="reviews">18 đánh giá</div> -->
    </div>
    </a>
     <!-- Product 5 -->
     <a href="sanpham/ryzen5.php" class="product-link">
        <div class="product-card">
            <img src="assets/upload/products/5.jpg" alt="Intel">
            <h5 class="flash-product__name">Bộ vi xử lý AMD Ryzen 7 5800X / 3.8GHz Boost 4.7GHz / 8 nhân 16 luồng / 32MB / AM4</h5>
            <span class="flash-product__price">Liên hệ</span>
            <div class="stars">★★★★★</div>
            <!-- <div class="reviews">12 đánh giá</div> -->
        </div>
    ...
    <!-- Product 6 -->
    <a href="sanpham/ryzen6.php" class="product-link">
        <div class="product-card">
            <img src="assets/upload/products/6.jpg" alt="intel">
            <h5 class="flash-product__name">Bộ vi xử lý AMD Ryzen 7 5800X / 3.8GHz Boost 4.7GHz / 8 nhân 16 luồng / 32MB / AM4</h5>
            <span class="flash-product__price">Liên hệ</span>
            <div class="stars">★★★★★</div>
            <!-- <div class="reviews">1 đánh giá</div> -->
    ...
    <!-- Product 7 -->
    <a href="sanpham/ryzen7.php" class="product-link">
        <div class="product-card">
            <img src="assets/upload/products/7.jpg" alt="intel ">
            <h5 class="flash-product__name">Bộ vi xử lý AMD Ryzen 9 9900X / 4.4GHz Boost 5.6GHz / 12 nhân 24 luồng / 76MB / AM5
            </h5>
            <span class="flash-product__price">Liên hệ</span>
            <div class="stars">★★★★★</div>
            <!-- <div class="reviews">2 đánh giá</div> -->
    ...
    <!-- Product 8 -->
    <a href="sanpham/ryzen8.php" class="product-link">
        <div class="product-card">
            <img src="assets/upload/products/8.jpg" alt="intel">
            <h5 class="flash-product__name">Bộ vi xử lý AMD Ryzen 9 9900X / 4.4GHz Boost 5.6GHz / 12 nhân 24 luồng / 76MB / AM5
            </h5>
            <span class="flash-product__price">Liên hệ</span>
            <div class="stars">★★★★★</div>
