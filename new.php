...
<!-- giới thiệu -->
<div class="pabout-history-head pabout-head"><h3>Lịch sử hình thành và phát triển</h3></div>
<div class="container">
                <div class="row align-items">
                    <div class="col col-lg-6 col-md-6 col-sm-12 about__left">
                        <img src="assets/upload/news/21.png" alt="">
                    </div>
                    <div class="col col-lg-6 col-md-6 col-sm-12 about__right">
                        <h6>Lịch sử hình thành và phát triển</h6>
                        <h1>Công Ty Tin Học Viết Sơn</h1>
...
/* Media query for devices smaller than 768px (phones) */
@media (max-width: 767px) {
    ...
    .about__left img {
        width: 100%; /* Ensure the image does not exceed the width of the container */
        height: auto;
    }
